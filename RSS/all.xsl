...
elementFormDefault="qualified">
  ...
  <xsl:template match="/">
    <html>
		<body>
			<table style="margin-bottom:8px;margin-top:4px;"  cellpadding="10" border="0" width="100%" align="center">
				<tr>
			...
			<xsl:for-each select="rss/channel/item">
			 ...
			 <xsl:sort select="substring(pubDate,24,2)" data-type="number" order="descending"/>
				...
				<table border="0" width="100%" align="center" onmouseover="style.backgroundColor='#E9E7E7'" onmouseout="style.backgroundColor='transparent'">
					<tr>
						<xsl:choose>
